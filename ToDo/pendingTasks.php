...
<head>
    ...
    <style>
        ...
        .searchBtn{
          margin-left: 10px; border-radius: 15px; height: fit-content; padding: 6px 15px 6px 15px
        }
        button a{
          color: white;
        }
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <li><a class="dropdown-item text-dark" href="main.php">Home</a></li>
              ...
              <li><a class="dropdown-item text-danger" href="pendingTasks.php">Pending Tasks</a></li>
            </ul>
          </li>
          <li>
